...
import { FaRocket, FaUserTie, FaRegBuilding } from "react-icons/fa";
...
export default function HRPayroll() {
  ...
  const service = {
    ...
    modules: [
      { title: "Smart Attendance & Time Tracking", icon: <FiClock className="w-5 h-5" />, features: ["AI Face Recognition", "Geo-Fencing", "Shift Management", "Biometric Integration", "Overtime Tracking", "Mobile Check-in/out"] },
      { title: "Payroll Processing & Compliance", icon: <FiDollarSign className="w-5 h-5" />, features: ["One-Click Payroll", "Statutory Compliance", "Payslip Generation", "Loan & Advance Management", "Tax Calculations", "Bank Integration"] },
      { title: "Employee Lifecycle Management", icon: <FaUserTie className="w-5 h-5" />, features: ["Digital Onboarding", "Employee Database", "Asset Management", "Exit Management", "Contract Management", "Document Repository"] },
      { title: "Leave & Expense Management", icon: <FiCalendar className="w-5 h-5" />, features: ["Self-Service Portal", "Approval Workflows", "Expense Claims", "Holiday Calendars", "Leave Balance Tracking", "Manager Approvals"] },
      { title: "Performance & Analytics", icon: <FiBarChart2 className="w-5 h-5" />, features: ["Appraisal Management", "HR Analytics", "Skills Matrix", "Salary Trends", "Goal Tracking", "360-Degree Reviews"] },
      { title: "HR Operations", icon: <FaRegBuilding className="w-5 h-5" />, features: ["Organization Chart", "Policy Management", "HR Ticket System", "Announcements", "Employee Directory", "Task Management"] },
    ],
    stats: [
          ...
          <div className="relative z-20 h-full flex flex-col justify-center max-w-6xl mx-auto px-6 lg:px-12">
            <div className="max-w-xl">
              ...
              <div className="flex items-center gap-3 mb-6 overflow-hidden">
                ...
                >HR & Payroll Solution</motion.span>
              </div>
