...
import {
  ...
  FaChartBar, FaRobot, FaServer, FaWhatsapp,
} from "react-icons/fa";
...
export default function AIAnalytics() {
   ...
   modules: [
  {
    ...
    features: ["Executive Command Centers", "Visual Storytelling", "Drill-Down Capabilities", "Mobile Analytics"]
  },
  {
    title: "Predictive Analytics & Forecasting",
    icon: <FaBrain className="w-5 h-5" />,
    features: ["Demand Forecasting", "Churn Prediction", "Cash Flow Projection", "Risk Assessment"]
  },
  {
    title: "Operational & Performance Analytics",
    icon: <FaChartLine className="w-5 h-5" />,
    features: ["Efficiency Metrics", "Supply Chain Optimization", "Sales Performance", "Cost Analysis"]
  },
  {
    title: "Data Management & Integration",
    icon: <FaServer className="w-5 h-5" />,
    features: ["Data Warehousing", "ETL Services", "Automated Reporting", "Custom AI Models"]
  },
],
  };
          ...
          >
            ...
            <div className="relative z-10 p-10 lg:p-20 lg:pl-24 max-w-3xl">
              ...
              <div className="flex items-center gap-3 mb-8 overflow-hidden">
                ...
                <span className="text-[#2B55C5] text-xs font-bold tracking-[0.3em] uppercase">AI & Analytics Solution</span>
              </div>

              <h1 className="text-4xl lg:text-6xl font-bold text-white mb-8 leading-tight tracking-tight flex flex-wrap gap-x-3">
                {["AI", "&", "Business", "Analytics"].map((word, wordIdx) => (
