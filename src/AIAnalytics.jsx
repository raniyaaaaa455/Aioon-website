...
import {
  FiArrowRight, FiCheckCircle, FiDollarSign, FiTrendingUp,
  FiClock, FiHardDrive, FiMapPin, FiMail, FiPhone,
} from "react-icons/fi";
import {
  FaRocket, FaBrain, FaChartLine, FaChartPie,
  FaChartBar, FaRobot, FaServer,
} from "react-icons/fa";
...
export default function AIAnalytics() {
  ...
  const service = {
    ...
    imageUrl: aiImage,
    description: "Stop guessing and start knowing. Transform raw data into strategic foresight with AI-powered intelligence and real-time visualization.",
    fullDescription: "In the digital age, businesses are flooded with data, but data without context is just noise. Our AI & Business Analytics service bridges the gap between raw information and strategic action. We integrate disparate data streams from your ERP, CRM, and legacy systems to build a 'Single Source of Truth' for your organization. By leveraging advanced Machine Learning algorithms and intuitive Business Intelligence (BI) tools, we help you move beyond reactive reporting to proactive planning. Whether it is predicting market trends, identifying operational bottlenecks, or personalizing customer experiences, our solutions provide the clarity leadership teams need to navigate uncertainty and drive confident growth.",
    longDescription: "Our AI-powered analytics platform empowers you to make data-driven decisions with confidence. From executive dashboards to predictive forecasting, we provide the tools and insights needed to stay ahead in today's competitive landscape. With seamless integration across all your business systems, every decision is backed by real-time, accurate intelligence.",
    features: [
      "Turn raw data into actionable intelligence",
      "Predict market trends and customer behavior",
      "Real-time visualization and executive dashboards",
      ...
      "Proactive planning vs reactive reporting",
      "Supply chain optimization and demand forecasting",
      "Risk assessment and cash flow projection",
    ],
    modules: [
      { title: "BI Dashboards", icon: <FaChartPie className="w-5 h-5" />, features: ["Executive Command Centers","Visual Storytelling","Drill-Down Capabilities","Mobile Analytics","Real-time KPI Tracking","Custom Report Generation"] },
      { title: "Predictive Analytics & Forecasting", icon: <FaBrain className="w-5 h-5" />, features: ["Demand Forecasting","Churn Prediction","Cash Flow Projection","Risk Assessment","Market Trend Analysis","Sales Forecasting"] },
      { title: "Operational & Performance Analytics", icon: <FaChartLine className="w-5 h-5" />, features: ["Efficiency Metrics","Supply Chain Optimization","Sales Performance","Cost Analysis","Inventory Analytics","Production Efficiency"] },
      { title: "Data Management & Integration", icon: <FaServer className="w-5 h-5" />, features: ["Data Warehousing","ETL Services","Automated Reporting","Custom AI Models","Legacy System Integration","Real-time Data Sync"] },
      { title: "Machine Learning & AI", icon: <FaRobot className="w-5 h-5" />, features: ["Pattern Recognition","Anomaly Detection","Recommendation Engine","Process Automation","Natural Language Processing","Image Recognition"] },
      { title: "Data Visualization", icon: <FaChartBar className="w-5 h-5" />, features: ["Interactive Dashboards","Geospatial Analytics","Trend Analysis","What-If Scenarios","Benchmarking","Executive Summaries"] },
    ],
    stats: [
      { value: "40%",  label: "Faster Decision Making",    icon: FiClock },
      { value: "35%",  label: "Reduced Operational Costs", icon: FiDollarSign },
      { value: "50%",  label: "More Accurate Forecasts",   icon: FiTrendingUp },
      { value: "10M+", label: "Data Points Processed",     icon: FiHardDrive },
    ],
  };
          ...
          <div className="relative z-20 h-full flex flex-col justify-center max-w-6xl mx-auto px-6 lg:px-12">
            <div className="max-w-xl">
              ...
              <div className="flex items-center gap-3 mb-6 overflow-hidden">
                ...
                >AI & Analytics Solution</motion.span>
              </div>
