...
import { FaRocket, FaRegEnvelope, FaWhatsapp } from "react-icons/fa";
          ...
          >
            ...
            <div className="relative z-10 p-10 lg:p-20 lg:pl-24 max-w-3xl">
              ...
              <div className="flex items-center gap-3 mb-8 overflow-hidden">
                ...
                <span className="text-[#2B55C5] text-xs font-bold tracking-[0.3em] uppercase">CRM Solution</span>
              </div>

              <h1 className="text-4xl lg:text-6xl font-bold text-white mb-8 leading-tight tracking-tight flex flex-wrap gap-x-3">
                {["Customer", "Relationship", "Management"].map((word, wordIdx) => (
