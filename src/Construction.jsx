...
export default function Construction() {
   ...
   modules: [
  {
    ...
    features: ["Progress Tracking", "Gantt Charts", "Milestone Management", "Daily Site Logs (DPR)"]
  },
  {
    title: "Estimation, Tendering & BOQ",
    icon: <FiFileText className="w-5 h-5" />,
    features: ["Bill of Quantities (BOQ)", "Cost Estimation", "Bid Management", "Rate Analysis"]
  },
  {
    title: "Material & Inventory Management",
    icon: <FaTruckLoading className="w-5 h-5" />,
    features: ["Site Inventory", "Material Indents", "Wastage Control", "Asset Management"]
  },
  {
    title: "Subcontractor & Labor Management",
    icon: <FaHardHat className="w-5 h-5" />,
    features: ["Subcontractor Billing", "Labor Attendance", "Compliance Tracking", "Performance Rating"]
  },
  {
    title: "Financials & Budget Control",
    icon: <FiDollarSign className="w-5 h-5" />,
    features: ["Project Budgeting", "Client Billing", "Cash Flow Planning", "Profitability Analysis"]
  },
],
  };
          ...
          >
            ...
            <div className="relative z-10 p-10 lg:p-20 lg:pl-24 max-w-3xl">
              ...
              <div className="flex items-center gap-3 mb-8 overflow-hidden">
                ...
                <span className="text-[#2B55C5] text-xs font-bold tracking-[0.3em] uppercase">Construction ERP Solution</span>
              </div>

              <h1 className="text-4xl lg:text-6xl font-bold text-white mb-8 leading-tight tracking-tight flex flex-wrap gap-x-3">
                {["Project", "&", "Construction", "ERP"].map((word, wordIdx) => (
